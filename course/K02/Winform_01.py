...
class MainForm(Form):
	...
	def InitializeComponent(self):
		...
		self._txtb_ext_tab_path.Text = "A:\TRAINING DYNAMO API\3.OUT\pyOpenDyn.extension\pyOpenDyn.tab\AddToolV2.panel\Add Tool.pushbutton"
		# 
		# btn_ext_tab_path
		# 
		...
		self._txtb_panel_name.Name = "txtb_panel_naem"
